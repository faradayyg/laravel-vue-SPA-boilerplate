...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_sweetalert__ = __webpack_require__(24);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__helpers_http__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__helpers_store__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__helpers_event_bus__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_vee_validate__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_vue_toastr__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_vue_toastr___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9_vue_toastr__);
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.mixin({
  data: function data() {
    return {
      http: __WEBPACK_IMPORTED_MODULE_5__helpers_http__["a" /* default */],
      config: config,
      eventBus: __WEBPACK_IMPORTED_MODULE_7__helpers_event_bus__["a" /* default */],
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_9_vue_toastr___default.a);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_top_progress__ = __webpack_require__(21);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pages_Home_vue__ = __webpack_require__(56);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pages_Login_vue__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pages_Login_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__pages_Login_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_ProtectedPage_vue__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_ProtectedPage_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__pages_ProtectedPage_vue__);
...
var routes = [{
	...
	path: '/login',
	component: __WEBPACK_IMPORTED_MODULE_1__pages_Login_vue___default.a,
	meta: {
		requiresAuth: false
	}
}, {
	path: '/protected',
	component: __WEBPACK_IMPORTED_MODULE_2__pages_ProtectedPage_vue___default.a,
	meta: {
		requiresAuth: true
	}
}];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__event_bus__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__config_env__ = __webpack_require__(12);
...
var authToken = window.localStorage.getItem(__WEBPACK_IMPORTED_MODULE_2__config_env__["default"].cookie_name);
...
var http = {
  axios: __WEBPACK_IMPORTED_MODULE_0_axios___default.a.create({ baseURL: __WEBPACK_IMPORTED_MODULE_2__config_env__["default"].base_url, headers: headers }),
  send: function send(type, args) {
    if (!running) {
      __WEBPACK_IMPORTED_MODULE_1__event_bus__["a" /* default */].$emit('ajax.begun');
    }
    running++;
    var respond = function respond(func, resp) {
      running--;
      if (!running) __WEBPACK_IMPORTED_MODULE_1__event_bus__["a" /* default */].$emit('ajax.ended');
      if (!resp) resp = {};
      func(resp.data, resp.headers, resp.status);
    };
    return new Promise(function (resolve, reject) {
      this[type].apply(this, args).then(function (resp) {
        respond(resolve, resp);
        if (resp.headers['x-refreshed-token']) {
          window.localStorage.setItem(__WEBPACK_IMPORTED_MODULE_2__config_env__["default"].cookie_name, resp.headers['x-refreshed-token']);
        ...
        if (resp && resp.status) {
          ...
          if (resp.status == 401) {
            __WEBPACK_IMPORTED_MODULE_1__event_bus__["a" /* default */].$emit('token.expired');
  ...
  headerIs: function headerIs(name, value) {
    return headers[name] == value;
  },
  setHeaders: function setHeaders(new_headers) {
    headers = new_headers;
    return this.renew();
  },
  setHeader: function setHeader(name, value, norenew) {
    headers[name] = value;
    if (!norenew) this.renew();
    return this;
  },
  removeHeader: function removeHeader(name, norenew) {
    delete headers[name];
    if (!norenew) this.renew();
    return this;
  }
...
var store = new __WEBPACK_IMPORTED_MODULE_0_vuex__["a" /* default */].Store({
  ...
  actions: {
    setUser: function setUser(_ref, users) {
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../css-loader/index.js!../../sass-loader/lib/loader.js!./vue-toastr.scss", function() {
			var newContent = require("!!../../css-loader/index.js!../../sass-loader/lib/loader.js!./vue-toastr.scss");
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(59)("13fdd6ba", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
  ...
  return _c("div", { staticClass: "mt-4 pt-4" }, [
    ...
    _c("h2", [
      ...
      _c(
        "small",
        [
          _c("router-link", { attrs: { to: "/protected" } }, [
            _vm._v("Protected Page")
          ])
        ],
        1
      )
...
Component.options.__file = "resources/js/pages/ProtectedPage.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5d7f6e24", Component.options)
  } else {
    hotAPI.reload("data-v-5d7f6e24", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "pt-2 text-center" }, [
      _c("h2", [
        _vm._v("\n\t\tYou are logged in, Somehow. Congratulations!!\n\t")
      ])
    ])
  }
]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5d7f6e24", module.exports)
  }
}
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "pt-4 mt-4 text-center" }, [
      _c("h2", [
        _vm._v(
          "\n\t\tYou can only see this page if you have window.localStorage.getItem(config.cookie_name) set.\n\t"
        )
      ])
    ])
  }
